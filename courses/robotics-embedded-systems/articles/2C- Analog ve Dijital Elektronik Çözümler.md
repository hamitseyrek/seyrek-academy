...
Bu dosya, `2S- Analog ve Dijital Elektronik Sorular.md` içindeki **S1-S20** numaralı sorular için özet çözümler ve açıklamalar içerir.

---

## S1 – Analog vs Dijital Örnekler

**1.1) Örnek sınıflandırma**  
...
## S3 – Çözünürlük Algısı

**3.1)** 0–5 V aralığı için:  
...
## S4 – ADC Giriş Aralığı Dışına Çıkmak
...
## S5 – Dijital Sinyallerde Gürültü
...
## S7 – Bit Artışının Etkisi

**7.1)** 0–5 V için:  
- 8 bit: \(V_{lsb,8} ≈ 5V / 255 ≈ 19.6 mV\)  
- 12 bit: \(V_{lsb,12} ≈ 5V / 4095 ≈ 1.22 mV\)  

**7.2)** 12 bit ADC, 8 bite göre yaklaşık \(19.6 / 1.22 ≈ 16\) kat daha ince gerilim adımı sağlar; küçük farkları daha iyi ayırt eder.

---

## S8 – Örnekleme ve Nyquist

**8.1)** Nyquist kriteri: \(f_s ≥ 2 × f_{max}\).  
- 1 kHz sinyal için minimum örnekleme: **2 kHz**.  
- Pratikte biraz daha yüksek (ör. 4–8 kHz) seçilir.  

**8.2)** Sıcaklık gibi yavaş sinyallerde temel frekans çok düşüktür (saniyede birkaç değişim bile nadirdir); saniyede 1–10 örnek bile Nyquist şartının çok üzerindedir. Bu nedenle aliasing tipik olarak problem olmaz.
...
## S10 – Potansiyometre ve Gerilim Bölücü

**10.1)** 0–5 V, 10 bit ADC için:  
...
**11.2)** LED parlaklığı, ortalama güce kabaca orantılıdır; dolayısıyla duty arttıkça LED daha parlak görünür.

---

## S12 – PWM Frekansı ve Algı
...
## S16 – Işık Sensörü ile Aydınlatma Kontrolü

**16.1)** Örnek blok şema:  
...
## S18 – Basit Dijital Filtreleme Fikri

**18.1)** Örnek yöntemler:  
...
## S19 – ADC Ölçümlerinde Toprak Referansı
...
## S20 – Gömülü Sistemde Sinyal Zincirini Tasarlama
